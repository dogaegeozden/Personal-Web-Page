...
ALLOWED_HOSTS = ["127.0.0.1", "dogaegeozden.com", "www.dogaegeozden.com", "143.42.8.21"]

# A list of trusted hosts. 
CSRF_TRUSTED_ORIGINS = ["http://127.0.0.1", "http://143.42.8.21", "https://143.42.8.21", "http://localhost", "http://www.dogaegeozden.com", "https://www.dogaegeozden.com", "http://dogaegeozden.com", "https://dogaegeozden.com"]
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'pages.context_processors.social_media_link_processor',
                'pages.context_processors.contact_information_processor',
                'pages.context_processors.cookie_notice_processor',
                'pages.context_processors.brand_identity_processor',
                'pages.context_processors.subscription_form_processor',
                'accountportal.context_processors.account_portal_meta_description_processor',
            ],
        },
    },
]
...
RECAPTCHA_PUBLIC_KEY = 'Enter your recaptcha public key here'
RECAPTCHA_PRIVATE_KEY = 'Enter your recaptcha private key here'